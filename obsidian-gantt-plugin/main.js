...
var root_9$1 = /* @__PURE__ */ from_html(`<span> </span>`);
var root_7$1 = /* @__PURE__ */ from_html(`<div class="card-dates svelte-x7v2jt"><!> <!></div>`);
var root_10$1 = /* @__PURE__ */ from_html(`<div class="card-footer svelte-x7v2jt"><button class="btn-add-subtask svelte-x7v2jt" title="Add subtask">+ Subtask</button></div>`);
var root_2$2 = /* @__PURE__ */ from_html(`<div draggable="true" role="listitem"><!> <div class="card-header svelte-x7v2jt"><span class="card-title svelte-x7v2jt" role="button" tabindex="0"> </span> <span class="priority-badge svelte-x7v2jt"> </span></div> <!> <!> <!> <!></div>`);
  ...
  each(div, 5, () => columns, index, ($$anchor2, col) => {
      ...
      ($$anchor3, card) => {
          ...
          var consequent_5 = ($$anchor4) => {
            ...
            var node_5 = child(div_11);
            {
              var consequent_3 = ($$anchor5) => {
                ...
                template_effect(() => set_text(text_7, `📅 ${(get(card), untrack(() => get(card).startDate)) ?? ""}`));
                append($$anchor5, span_7);
              };
              if_block(node_5, ($$render) => {
                if (get(card), untrack(() => get(card).startDate)) $$render(consequent_3);
              });
            }
            var node_6 = sibling(node_5, 2);
            {
              var consequent_4 = ($$anchor5) => {
                ...
                template_effect(() => set_text(text_8, `→ ${(get(card), untrack(() => get(card).endDate)) ?? ""}`));
                append($$anchor5, span_8);
              };
              if_block(node_6, ($$render) => {
                if (get(card), untrack(() => get(card).endDate)) $$render(consequent_4);
              });
            }
            append($$anchor4, div_11);
          };
          if_block(node_4, ($$render) => {
            if (get(card), untrack(() => get(card).startDate || get(card).endDate)) $$render(consequent_5);
          });
        }
        var node_7 = sibling(node_4, 2);
        {
          ...
          if_block(node_7, ($$render) => {
            if (get(card), untrack(() => !get(card).isSubtask)) $$render(consequent_6);
          });
        }
        template_effect(
          ($0) => {
    ...
    var node_8 = sibling(node, 2);
    {
      ...
      if_block(node_8, ($$render) => {
        if (get(colCards), get(col), untrack(() => get(colCards)[get(col).id].length === 0)) $$render(consequent_7);
      });
    }
    template_effect(() => {
...
var root_1$2 = /* @__PURE__ */ from_html(`<div><!> <div class="gantt-task-label-wrap svelte-152mm6m"><span class="gantt-task-link svelte-152mm6m" role="link" tabindex="0"> </span> <!></div> <span class="status-dot svelte-152mm6m"></span> <!></div>`);
var root_8 = /* @__PURE__ */ from_html(`<div class="gantt-month-cell svelte-152mm6m"> </div>`);
...
function GanttChart($$anchor, $$props) {
  ...
  each(div_7, 5, () => get(headerMonths), index, ($$anchor2, m) => {
    var div_8 = root_8();
    var text_3 = child(div_8);
    template_effect(() => {
      set_style(div_8, `width:${(get(m), untrack(() => get(m).span * DAY_WIDTH)) ?? ""}px`);
      set_text(text_3, (get(m), untrack(() => get(m).label)));
    });
    append($$anchor2, div_8);
  });
  var div_9 = sibling(div_7, 2);
  each(div_9, 5, () => get(dayHeaders), index, ($$anchor2, dh) => {
    var div_10 = root_9();
    let classes_1;
    set_style(div_10, "width:32px");
    var text_4 = child(div_10);
    template_effect(() => {
      classes_1 = set_class(div_10, 1, "gantt-day-cell svelte-152mm6m", null, classes_1, { weekend: get(dh).isWeekend, "today-col": get(dh).isToday });
  ...
  var node_4 = child(div_11);
  {
    var consequent_4 = ($$anchor2) => {
      var div_12 = root_10();
      template_effect(() => set_style(div_12, `left:${get(todayIdx) * DAY_WIDTH + DAY_WIDTH / 2}px; height:${(get(rows), untrack(() => get(rows).length * ROW_HEIGHT)) ?? ""}px`));
  ...
  each(node_5, 1, () => get(rows), (row) => row.id, ($$anchor2, row) => {
    var div_13 = root_11();
    set_style(div_13, "height:40px");
    var node_6 = child(div_13);
    each(node_6, 1, () => get(dayHeaders), index, ($$anchor3, dh, i) => {
      var div_14 = root_12();
      let classes_2;
      set_style(div_14, "width:32px");
      template_effect(() => classes_2 = set_class(div_14, 1, "gantt-grid-cell svelte-152mm6m", null, classes_2, { weekend: get(dh).isWeekend, "today-col": get(dh).isToday }));
      event("click", div_14, () => onCellClick(get(row), i));
    ...
    var node_7 = sibling(node_6, 2);
    {
      var consequent_5 = ($$anchor3) => {
        ...
        var div_17 = sibling(span_6, 2);
        template_effect(() => {
          set_style(div_15, `left:${(deep_read_state(get(bar)), untrack(() => get(bar).startDay * DAY_WIDTH)) ?? ""}px; width:${(deep_read_state(get(bar)), untrack(() => (get(bar).endDay - get(bar).startDay + 1) * DAY_WIDTH)) ?? ""}px; background:${(get(row), untrack(() => get(row).barColor)) ?? ""}; top:8px;`);
          set_text(text_5, (get(row), untrack(() => get(row).title)));
        });
        event("mousedown", div_16, (e) => onBarMouseDown(get(row), "resize-start", e));
        event("mousedown", div_17, (e) => onBarMouseDown(get(row), "resize-end", e));
        event("mousedown", div_15, (e) => onBarMouseDown(get(row), "move", e));
